...
const TimeZoneSelector = ({ value, onChange }) => {
    ...
    return (_jsx(Select, { variant: "outlined", value: value, onChange: (e) => onChange(e.target.value), children: timeZones.map((zone) => (_jsx(MenuItem, { value: zone.value, selected: value === zone.value, children: zone.label }, zone.value))) }));
};
